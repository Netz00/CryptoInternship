...
contract("myERC20", (accounts) => {
  ...
  beforeEach('setup contract for each test', async function () {
    contract = await myERC20.new(_name,_symbol,maximum_supply)
});
...
*/
  ...
  it("owner should mint 10000 AYM in his account", () => {
    let meta;
    ...
    myERC20
      .new(_name, _symbol, maximum_supply)
  ...
  it("mint 10 000 000 000 000 AYM what exceeds maximum supply, should fail", () => {
    let meta;
    let starting_balance;
    let ending_balance;
